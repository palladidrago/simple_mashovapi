...
class Controller {
  ///This is the api controller. You can log in and request various things.
  ...
  Future<List<dynamic>> _getGradesRaw() async {
    //Returns a list of [Grade], in raw "json" (It's actually a map<string,dynamic).
  ...
  Future<List<Grade>> getGradeList() async {
    ...
    var grades = List<Grade>.filled(gradesRaw.length,null); //Empty grade list
